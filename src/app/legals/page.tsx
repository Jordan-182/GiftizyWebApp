  ...
  return (
    <article className="max-w-3xl mx-auto prose space-y-4">
      ...
      <section>
        ...
        <p>
          L&apos;ensemble des éléments (textes, images, graphismes, logos,
          icônes, sons, logiciels, etc.) présents sur ce site est protégé par le
          droit de la propriété intellectuelle et appartient à l&apos;éditeur du
          site ou à des tiers ayant autorisé l&apos;éditeur à les utiliser.
      ...
      <section>
        ...
        <p>
          ...
          site, mais ne saurait garantir l&apos;exactitude, la complétude ou
          l&apos;actualité des informations. L&apos;utilisateur est seul
          responsable de l&apos;usage des informations disponibles sur le site.{" "}
          <br />
          Ce projet est fourni en l&apos;état, sans garantie. L&apos;éditeur ne
          saurait être tenu responsable en cas de bug, perte de données, ou
      ...
      <section>
        ...
        <p>
          ...
          d&apos;autres sites. L&apos;éditeur n&apos;est pas responsable du
          contenu de ces sites externes et décline toute responsabilité quant
          aux informations qui y sont diffusées.
        </p>
      </section>
